...
> A Hexo plugin to generate unique abbreviated links for Markdown files
...
```bash
pnpm add hexo-plugin-abbrlink
# or
npm install hexo-plugin-abbrlink
# or
yarn add hexo-plugin-abbrlink
```

## 🚀 Usage

Add it to your plugins in `_config.yml`:
...
1. The plugin scans the configured Markdown files during Hexo's post rendering process
...
5. It processes files automatically during Hexo's build process
